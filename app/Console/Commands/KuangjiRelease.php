...
class KuangjiRelease extends Command
{
    ...
    private function orderRelease($uid, $totalNum, $orderId = 0)
    {
        ...
        // 用户余额日志增加
        AccountLog::addLog($uid, $coin->id, $num, 20, 1, Account::TYPE_LC, '矿机释放');

        // 矿池表信息增加
        UserWalletLog::addLog($uid, 'kuangji_order', $orderId, '矿机释放', '-', $totalNum, 2, 1);
