...
class User extends Model
{
    ...
    protected $fillable = ['mobile', 'email', 'password', 'pid', 'invite_code', 'type', 'path', 'pid_path', 'nickname', 'new_account','int_code','created_at'];
...
//            HoldCoin::create(['uid'=>$model->id]);
    ...
    {
//        return url('/register');
        return 'https://apinew.too86.top/register';
    }
